...
1. **Create a Greyscale Image:**
   - Converts the input image to greyscale and saves the result.
     ...
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/grayscaleImage.jpeg" alt="Greyscale Image" width="600"/>


2. **Change Brightness:**
   - Adjusts the brightness of the image based on user input.
     
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/changedBrightnessImage.jpeg" alt="changedBrightnessImage" width="600"/>

3. **Invert Image Horizontally:**
   - Produces an inverted version of the input image horizontally.
     
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/invertHorintallyImage.jpeg" alt="invertHorintallyImage" width="600"/>

4. **Invert Image Vertically:**
   - Produces an inverted version of the input image vertically.
     
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/invertVerticallyImage.jpeg" alt="invertVerticallyImage" width="600"/>

5. **Mosaic Blur:**
   - Applies a mosaic blur effect to the image based on user-defined strength.
     
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/bluredImage.jpeg" alt="bluredImage" width="600"/>
...
8. **Rotate Image 90 Degrees Clockwise:**
   - Rotates the image 90 degrees clockwise.
     ...
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/clockwise90.jpeg" alt="clockwise90" width="400"/>

9. **Rotate Image 90 Degrees Anticlockwise:**
   - Rotates the image 90 degrees anticlockwise.
     
     <img src="https://github.com/Rudrakc/Image_Editor/blob/main/Output_Images/anticlock90.jpeg" alt="anticlock90" width="400"/>
